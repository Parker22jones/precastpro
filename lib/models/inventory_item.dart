...
List<InventoryItem> defaultInventory() => [
  ...
  InventoryItem(
    sku: 'EJ-1860',
    description: 'EJ 1860 Regular Frame & Grate',
    category: StockCategory.casting,
    onHand: 14,
    minThreshold: 6,
  ),
  ...
  InventoryItem(
    sku: 'EJ-1337Z',
    description: 'EJ 1337Z/1338A Storm Regular',
    category: StockCategory.casting,
    onHand: 9,
    minThreshold: 4,
  ),
  ...
  InventoryItem(
    sku: 'PSX-DD',
    description: 'Press-Seal PSX Direct Drive Sleeve',
  ...
  InventoryItem(
    sku: 'PSX-ND',
    description: 'Press-Seal PSX Nylo Drive Sleeve',
    category: StockCategory.accessory,
    onHand: 16,
    minThreshold: 8,
  ),
